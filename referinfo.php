...
echo '<title>五宮鉄道オンライン予約 情報照会</title>';
echo '</head>';
...
if ($_POST["uriselector"]=="APIGW") {
	$MEMBERS_TARGET='http://iwahi01-apig92:8181/rest/default/aovcd/v1/members?nometa=true&sysfilter=equal(userid:"'.$_POST["userid"].'")';
	$MEMBER_RES_TARGET='http://iwahi01-apig92:8181/rest/default/aovcd/v1/member_reservation_order?nometa=true&sysfilter=equal(userid:"'.$_POST["userid"].'")';
